  ...
  <div class="col-4">
    <nav id="navbar-example3" class="h-100 flex-column align-items-stretch pe-4 border-end">
      <nav class="nav nav-pills flex-column">
        <a class="nav-link" href="#item-1">Abouts Us</a>
        <nav class="nav nav-pills flex-column">
          <a class="nav-link ms-3 my-1" href="#item-1-1">VESSEL MANAGEMENT</a>
          <a class="nav-link ms-3 my-1" href="#item-1-2">ENERGY, OIL AND GAS</a>
        </nav>
        <a class="nav-link" href="#item-2">CREW RECRUITMENT</a>
        <a class="nav-link" href="#item-3">CONSULTANCY</a>
        <nav class="nav nav-pills flex-column">
          <a class="nav-link ms-3 my-1" href="#item-3-1"> REAL ESTATE</a>
...
At EC GLOBAL Oil & Gas, we offer a host of quality services ranging from vessel management to general import and exports.
      ...
      <div id="item-1">
        <h4>OUR MISSION </h4>
        <p> Our mission statement is to provide a corporate support to our clients to justify and realize their objectives and targets without any problem
</p>
      </div>

      <div id="item-1">
        <h4>OUR Vision  </h4>
        <p> The company seeks to have more Tank Farms, Filling Stations, Gas plant, Food and Beverages, Import and Export, Transportation, Oil Tankers, Trucks and NGO Foundation as it expands. Moreover, it also seeks to inﬂuence positively, its environment to make its impact felt by the society by helping to ﬁnance orphanages and possibly building more of  such homes.
</p>
      </div>
      <div id="item-1-1">
...
We also sales vessel spare parts to Ship owners and managers can easily buy genuine vessel spares and equipment using our channel and experience to make the best choices. Make smarter purchasing decisions with access to our comprehensive databases and tools to purchase hard to ﬁnd vessel parts.
      ...
      <div id="item-2">
        <h4>CREW RECRUITMENT</h4>
        <p> Our Marine teams are experts in delivering the very best maritime personnel to projects worldwide within Oil & Gas, Cargo, Passenger and other vessels. We always have a variety of permanent and contract positions available and work in every ocean across the globe in locations such as Africa, Australia, Saudi Arabia, Mexico and Europe.
We have developed a strong reputation for delivering a consistently excellent standard of service, having staffed some of the most important offshore projects over the years. We work in close partnership with our clients to provide skilled, experienced and certiﬁed crew members, and to bring the most exciting marine opportunities worldwide to our candidates.
We also offer a fully bespoke Marine Crew Management service; through which we manage all aspects of crewing a vessel or vessels. This product is tailored to each client’s individual need, and can encompass managing just one or three smaller vessels right through to a ﬂeet of state-of-the-art DP3 vessels.

</p>
      </div>
      <div id="item-3">
        <h4>CONSULTANCY</h4>
        <p>We provide professional industry, marine and general consultation services to oil and gas exploration and production companies, ship and vessels and general merchandise. Our team of professionals provides top-notch consultation services for companies and individuals who seek advice and ideas in enterprises within the industry.
We also render all this services: Project management consulting, Detailed design,
Project control management, Advisory on oil and gas.
Real estate
        </p>
      </div>
      <div id="item-3-1">
